...
class MoviesViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var movies = [[String:Any]]() // array of dictionaries or a list of dictionaries.
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        tableView.deselectRow(at: indexPath, animated: true) //unhighlights the selected cell automatically.
    }
